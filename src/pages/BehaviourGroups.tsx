...
const BehaviourGroups = () => {
  ...
  return <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 bg-transparent">
      <div className="space-y-6">
        <h1 className="text-2xl font-semibold text-[#34502b]">Sustainability Behaviour Groups</h1>
        
        <BehaviourControls selectedCountry={selectedCountry} setSelectedCountry={setSelectedCountry} viewType={viewType} setViewType={setViewType} />
        
        <BehaviourGroupsChart selectedCountry={selectedCountry} viewType={viewType} />
        
        {selectedCountry && viewType === "trend" && <BehaviourGroupsDistribution selectedCountry={selectedCountry} />}

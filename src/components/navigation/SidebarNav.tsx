    ...
    <Sidebar className="border-r bg-[#34502b] text-white">
      ...
      <SidebarContent className="px-4">
        <SidebarMenu>
          ...
          <SidebarMenuItem>
            <Link 
              to="/sustainability-influences" 
              className={cn(
                "flex items-center gap-3 rounded-md px-3 py-2 text-sm",
                isActive("/sustainability-influences") ? "bg-white/10 text-white" : "hover:bg-white/5 transition-colors"
              )}
            >
          ...
          <SidebarMenuItem>
            <Link 
              ...
              className={cn(
                "flex items-center gap-3 rounded-md px-3 py-2 text-sm",
                isActive("/sustainability-impact") ? "bg-white/10 text-white" : "hover:bg-white/5 transition-colors"
              )}
            >

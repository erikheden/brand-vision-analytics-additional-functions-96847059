        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="md:col-span-3">
            {selectedCountries.length === 0 ? <Card className="p-6 bg-white border-2 border-[#34502b]/20 rounded-xl shadow-md">
              ...
              </Card> : activeTab === "yearly" ? <InfluencesBarChart data={combinedData} selectedYear={selectedYear} countries={selectedCountries} /> : <InfluencesTrendChart data={combinedData} selectedInfluences={selectedInfluences} countries={selectedCountries} />}
          </div>
        </div>
      </Tabs>
    </div>;
